...
from pii.anonymize import EntitySpan, anonymize_text
from pii.gliner_provider import _preload_sync
from pii.schemas import (
    AnonymizeRequest,
    AnonymizeResponse,
    DetectedEntity,
    EntitiesRequest,
...
async def entities_endpoint(req: EntitiesRequest) -> EntitiesResponse:
    ...
    from pii.anonymize import select_non_overlapping_entities
